...
//#define X_DUAL_STEPPER_DRIVERS	//TG 12/30/2020
#if ENABLED(X_DUAL_STEPPER_DRIVERS)
  #define INVERT_X2_VS_X_DIR true   // Set 'true' if X motors should rotate in opposite directions
  #define X_DUAL_ENDSTOPS	//TG 12/30/2020
...
//#define Y_DUAL_STEPPER_DRIVERS	//TG 12/30/2020
#if ENABLED(Y_DUAL_STEPPER_DRIVERS)
  #define INVERT_Y2_VS_Y_DIR true   // Set 'true' if Y motors should rotate in opposite directions
  #define Y_DUAL_ENDSTOPS	//TG 12/30/2020
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 1200	//TG 12/30/2020
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define SOUND_MENU_ITEM //TG 12/30/2020
...
#define LCD_TIMEOUT_TO_STATUS 180000	//TG 12/30/2020
  ...
  //#define EVENT_GCODE_SD_ABORT "G28XY"    //TG 12/30/2020 G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
  ...
  #define LONG_FILENAME_HOST_SUPPORT	//TG 1/9/2020 enabled for TFT35

  // Enable this option to scroll long filenames in the SD card menu
  #define SCROLL_LONG_FILENAMES	//TG 12/30/2020
 ...
 */
//#define BABYSTEPPING  //TG 12/30/2020
...
#define ARC_SUPPORT                 //TG 12/30/2020 Disable this feature to save ~3226 bytes
  ...
  #define MM_PER_ARC_SEGMENT    0.2 //TG 12/30/2020 (mm) Length (or minimum length) of each arc segment
 ...
 */
   ...
   */
  //#define STEALTHCHOP_XY	//TG 12/30/2020
  //#define STEALTHCHOP_Z	//TG 12/30/2020
  //#define STEALTHCHOP_E	//TG 12/30/2020
   ...
   */
  //#define MONITOR_DRIVER_STATUS	//TG 12/30/2020
 ...
 */
#define CUSTOM_USER_MENUS  //TG 12/30/2020
#if ENABLED(CUSTOM_USER_MENUS)
  #define CUSTOM_USER_MENU_TITLE "V1 Custom Menu"	//TG 12/30/2020
  #define USER_SCRIPT_DONE "M117 User Script Done"
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  //#define USER_SCRIPT_RETURN  // Return to status screen after a script

  #define USER_DESC_1 "Reset XYZ Coords (no motion)"	//TG 12/30/2020
  #define USER_GCODE_1 "G92 X0 Y0 Z0"	//TG 12/30/2020

  #define USER_DESC_2 "Home Z Axis"	//TG 12/30/2020
  #define USER_GCODE_2 "G28 Z"	//TG 12/30/2020

  #define USER_DESC_3 "Home X&Y"	//TG 12/30/2020
  #define USER_GCODE_3 "G28 X Y"	//TG 12/30/2020

  //#define USER_DESC_4 "Heat Bed/Home/Level" //TG 12/30/2020
  //#define USER_GCODE_4 "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nG28\nG29"

  //#define USER_DESC_5 "Home & Info" //TG 12/30/2020
...
#define HOST_ACTION_COMMANDS  		//TG 1/9/2020 enabled for TFT35
  ...
  #define HOST_PROMPT_SUPPORT		//TG 1/9/2020 enabled for TFT35
...
// M42 - Set pin states
//
#define DIRECT_PIN_CONTROL  //TG 1/12/20 enabled
