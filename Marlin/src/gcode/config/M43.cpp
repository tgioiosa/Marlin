...
inline void servo_probe_test() {
    ...
    // This code will try to detect a BLTouch probe or clone
      ...
      bltouch._reset();
      bltouch._stow();
      SERIAL_ECHOLNPAIR(". Z_MIN_PROBE_PIN state: ", int(READ(PROBE_TEST_PIN))); //TG 10/26/20 added
      ...
      SERIAL_ECHOLNPAIR(". ERROR-PROBE state not ", int(probe_inverting)); //TG 10/26/20 added
