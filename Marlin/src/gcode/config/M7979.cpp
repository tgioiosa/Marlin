/** //TG MODIFIED BY T.GIOIOSA  - adds M7979 for Spindle PID control
 ...
 * 
 *  gcode   function            TFT SEND to Marlin         Marlin RETURN to TFT       If CMD issued from REMOTE USB host
 * -------  --------------    ---------------------      ------------------------   -------------------------------------------------
...
char Msg[60];   // for use in some of the code below that needs a buffer
